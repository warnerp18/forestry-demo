...
describe('tabs component', () => {
  const fixture = `
    <section id="test-tabs-1" class="tabs js-tabs">
      <ol class="tablist js-tablist">
        <li><a class="tablist__item js-tab tablist__item--transparent" href="#tab1">Tab 1</a></li>
        <li><a class="tablist__item js-tab" href="#tab2">Tab 2</a></li>
      </ol>

      <div id="tab1" class="tabpanel js-tabpanel">
        <h2 class="tabpanel__header">Tab 1</h2>
        <p class="tabpanel__content"></p>
      </div>
    ...
    <section id="test-tabs-2" class="tabs js-tabs">
      <ol class="tablist js-tablist">
        <li><a class="tablist__item js-tab" href="#tab3">Tab 3</a></li>
        <li><a class="tablist__item js-tab" href="#tab4">Tab 4</a></li>
      </ol>
      ...
      <div id="tab4" class="tabpanel js-tabpanel">
        <h2 class="tabpanel__header">Tab 4</h2>
        <p class="tabpanel__content"></p>
      </div>
    </section>
  `;
  ...
  describe('when the function is called', () => {
    ...
    beforeEach(() => {
      ...
      component1 = {
        root: component1root,
        tablist: component1root.querySelector('.js-tablist'),
        tabs: Array.from(component1root.querySelectorAll('.js-tab')),
        panels: Array.from(component1root.querySelectorAll('.js-tabpanel')),
      };

      component2 = {
        root: component2root,
        tabs: component2root.querySelectorAll('.js-tab'),
        panels: component2root.querySelectorAll('.js-tabpanel'),
      };
    });
    ...
    it('adds the hidden attribute to all but the first tabpanel', () => {
    ...
    describe('when a tab is clicked', () => {
      ...
      it('sets the background to transparent on the clicked tab', () => {
        expect(component1.tabs[1]).toHaveClass('tablist__item--transparent');
      });

      it('sets the background to not transparent on the other tabs', () => {
