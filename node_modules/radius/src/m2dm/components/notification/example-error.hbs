{{> components/notification/example-notification
  notification-class-variation="notification--error"
  notification-no-variations="true"
  notification-title="A connection error has occured"
  notification-description="Due to a connection error, your transaction did not go through. Please try again."
